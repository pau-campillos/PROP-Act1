...
Classes modificades (a part del TO DO):
    - Mapa:
            Hem afegit una llista de posicions "claus" que guarda les claus que encara no hem recollit i les seves posicions. Es llegeix juntament amb el mapa, i cada cop que recollim una clau s'elimina aquesta de la llista. 
