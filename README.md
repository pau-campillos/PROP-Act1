...
A més, hem afegit funcions que interaccionen amb aquesta nova llista, les quals ens permeten, entre altres, trobar la clau més propera a un punt, saber si ens falten claus per trobar, etc. Finalment, hem afegit una funció per a saber si hi ha un agent en una posició en concret.
